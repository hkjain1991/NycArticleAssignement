...
data class ArticleMetaData(
    ...
    @SerializedName("des_facet") val desFacet: ArrayList<String> = arrayListOf(),
    @SerializedName("org_facet") val orgFacet: ArrayList<String> = arrayListOf(),
    @SerializedName("per_facet") val perFacet: ArrayList<String> = arrayListOf(),
